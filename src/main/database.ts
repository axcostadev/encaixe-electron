...
export function initDatabase(): void {
	...
	// Garantir execução serializada das criações de tabela e inserção do usuário padrão
	db.serialize(() => {
		...
		// Criar usuário padrão se não existir (inserção feita após criações de tabela)
		db.run(
